...
RSpec.describe EpicLadder::McpTools::CreateFeatureTool, type: :model do
  ...
  let(:epic_tracker) do
    Tracker.create!(name: EpicLadder::TrackerHierarchy.tracker_names[:epic], default_status: IssueStatus.first)
  end
  let(:feature_tracker) do
    Tracker.create!(name: EpicLadder::TrackerHierarchy.tracker_names[:feature], default_status: IssueStatus.first)
  end
