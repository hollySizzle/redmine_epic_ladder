...
FactoryBot.define do
  ...
  factory :epic_tracker, class: 'Tracker' do
    initialize_with do
      name = EpicLadderTestConfig::TRACKER_NAMES[:epic]
  ...
  factory :feature_tracker, class: 'Tracker' do
    initialize_with do
      name = EpicLadderTestConfig::TRACKER_NAMES[:feature]
  ...
  factory :user_story_tracker, class: 'Tracker' do
    initialize_with do
      name = EpicLadderTestConfig::TRACKER_NAMES[:user_story]
      Tracker.find_by(name: name) || begin
        status = IssueStatus.find_by(name: 'New') || IssueStatus.first
  ...
  factory :task_tracker, class: 'Tracker' do
    initialize_with do
      name = EpicLadderTestConfig::TRACKER_NAMES[:task]
      Tracker.find_by(name: name) || begin
        status = IssueStatus.find_by(name: 'New') || IssueStatus.first
  ...
  factory :test_tracker, class: 'Tracker' do
    initialize_with do
      name = EpicLadderTestConfig::TRACKER_NAMES[:test]
      Tracker.find_by(name: name) || begin
        status = IssueStatus.find_by(name: 'New') || IssueStatus.first
  ...
  factory :bug_tracker, class: 'Tracker' do
    initialize_with do
      name = EpicLadderTestConfig::TRACKER_NAMES[:bug]
      Tracker.find_by(name: name) || begin
        status = IssueStatus.find_by(name: 'New') || IssueStatus.first
