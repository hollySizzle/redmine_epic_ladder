...
class ImplementationDesignHook(BaseHook):
    ...
    def _process_command(self, tool_input: Dict[str, Any], session_id: str, input_data: Dict[str, Any]) -> Dict[str, str]:
        """
        コマンド実行時の規約チェック処理
