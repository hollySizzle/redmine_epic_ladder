...
- [技術アーキテクチャ規約（Redmine Release Kanban）](@vibes/rules/technical_architecture_standards.md)
- [Vibesドキュメント規約](@vibes/rules/vibes_documentation_standards.md)
- **testing**
  - [カンバンテスト戦略規約](@vibes/rules/testing/kanban_test_strategy.md)
...
### specs - システム仕様
- **ui**
  - [カンバンUI設計仕様書](@vibes/specs/ui/kanban_ui_design_spec.md)

### logics - ビジネスロジック
- [AutoGeneration技術実装仕様](@vibes/logics/auto_generation_implementation.md)
- [TrackerHierarchy技術実装仕様](@vibes/logics/tracker_hierarchy_implementation.md)
