...
export const normalizedMockData: NormalizedAPIResponse = {
  ...
  statistics: {
    ...
    trend: {
      completion_history: [
        { date: '2025-09-01', completion_rate: 40.0 },
        { date: '2025-09-08', completion_rate: 42.5 },
        { date: '2025-09-15', completion_rate: 45.0 },
        { date: '2025-09-22', completion_rate: 47.5 },
        { date: '2025-09-29', completion_rate: 50.0 }
      ],
      velocity: 5.5
    }
  }
