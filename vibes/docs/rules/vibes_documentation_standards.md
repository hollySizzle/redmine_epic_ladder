...
3. **目次更新**: `python3 /myapp/Source/rails/vibes/scripts/main.py --direct doc --action update_all`
4. **整合性確認**: `python3 /myapp/Source/rails/vibes/scripts/main.py --direct doc --action check_all`
