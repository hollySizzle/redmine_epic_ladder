...
2. **規約確認**: @vibes/rules/vibes_documentation_standards.md 参照
3. **目次更新**: `python3 /usr/src/redmine/plugins/redmine_epic_ladder/vibes/scripts/main.py --direct doc --action update_all`
4. **整合性確認**: `python3 /usr/src/redmine/plugins/redmine_epic_ladder/vibes/scripts/main.py --direct doc --action check_all`
