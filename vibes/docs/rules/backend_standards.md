...
- フロントエンド: `assets/javascripts/epic_ladder/src/mocks/handlers.ts`
...
- **MSW API仕様**: assets/javascripts/epic_ladder/src/mocks/handlers.ts
- **TypeScript型定義**: assets/javascripts/epic_ladder/src/types/normalized-api.ts
