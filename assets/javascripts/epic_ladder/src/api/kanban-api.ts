...
export async function fetchGridData(
  ...
  const url = `/api/epic_ladder/projects/${projectId}/grid${params.toString() ? `?${params}` : ''}`;
...
export async function fetchUpdates(
  ...
  const url = `/api/epic_ladder/projects/${projectId}/grid/updates?since=${encodeURIComponent(since)}`;
  const response = await fetch(url, {
...
export async function createEpic(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/epics`, {
    method: 'POST',
    credentials: 'same-origin',
...
export async function createFeature(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/cards`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
...
export async function createUserStory(
  ...
  const response = await fetch(
    `/api/epic_ladder/projects/${projectId}/cards/${featureId}/user_stories`,
    {
      method: 'POST',
      credentials: 'same-origin',
      headers: getRequestHeaders(true),
...
export async function createTask(
  ...
  const response = await fetch(
    `/api/epic_ladder/projects/${projectId}/cards/user_stories/${userStoryId}/tasks`,
    {
      method: 'POST',
      credentials: 'same-origin',
      headers: getRequestHeaders(true),
...
export async function createTest(
  ...
  const response = await fetch(
    `/api/epic_ladder/projects/${projectId}/cards/user_stories/${userStoryId}/tests`,
    {
      method: 'POST',
      credentials: 'same-origin',
      headers: getRequestHeaders(true),
...
export async function createBug(
  ...
  const response = await fetch(
    `/api/epic_ladder/projects/${projectId}/cards/user_stories/${userStoryId}/bugs`,
    {
      method: 'POST',
      credentials: 'same-origin',
      headers: getRequestHeaders(true),
...
export async function createVersion(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/versions`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
...
export async function moveFeature(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/grid/move_feature`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
...
export async function moveUserStory(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/grid/move_user_story`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
...
export async function reorderEpics(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/grid/reorder_epics`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
...
export async function reorderVersions(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/grid/reorder_versions`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
...
export async function batchUpdate(
  ...
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/grid/batch_update`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders(true),
    body: JSON.stringify(data)
 ...
 *
 * 実装予定のエンドポイント:
 * - DELETE /api/epic_ladder/projects/:project_id/epics/:id
 * - DELETE /api/epic_ladder/projects/:project_id/versions/:id
 * - DELETE /api/epic_ladder/projects/:project_id/features/:id
 * - DELETE /api/epic_ladder/projects/:project_id/user_stories/:id
 * - DELETE /api/epic_ladder/projects/:project_id/tasks/:id
 * - DELETE /api/epic_ladder/projects/:project_id/tests/:id
 * - DELETE /api/epic_ladder/projects/:project_id/bugs/:id
 *
 * 削除時の考慮事項:
 * - 子要素の連鎖削除またはorphan処理
 * - grid.indexからの削除
...
export async function resetMockData(projectId: number | string): Promise<void> {
  const response = await fetch(`/api/epic_ladder/projects/${projectId}/grid/reset`, {
    method: 'POST',
    credentials: 'same-origin',
    headers: getRequestHeaders()
  });
