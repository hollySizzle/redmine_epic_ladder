...
describe('MSW Handlers', () => {
  ...
  beforeEach(async () => {
    // 各テストの前にモックデータをリセット
    await fetch(`${baseUrl}/api/epic_ladder/projects/${projectId}/grid/reset`, {
      method: 'POST'
    });
  });

  describe('GET /api/epic_ladder/projects/:projectId/grid', () => {
    it('グリッドデータを取得できる', async () => {
      const response = await fetch(`${baseUrl}/api/epic_ladder/projects/${projectId}/grid`);
    ...
    it('include_closed=false でclosedステータスが除外される', async () => {
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/grid?include_closed=false`
      );
      const data: NormalizedAPIResponse = await response.json();
    ...
    it('include_closed=true でclosedステータスが含まれる', async () => {
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/grid?include_closed=true`
      );
      const data: NormalizedAPIResponse = await response.json();
  ...
  describe('POST /api/epic_ladder/projects/:projectId/grid/move_feature', () => {
    beforeEach(async () => {
      // モックデータをリセット
      await fetch(`${baseUrl}/api/epic_ladder/projects/${projectId}/grid/reset`, {
        method: 'POST'
    ...
    it('Featureを別のセルに移動できる', async () => {
      ...
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/grid/move_feature`,
        {
          method: 'POST',
  ...
  describe('POST /api/epic_ladder/projects/:projectId/grid/move_user_story', () => {
    beforeEach(async () => {
      // モックデータをリセット
      await fetch(`${baseUrl}/api/epic_ladder/projects/${projectId}/grid/reset`, {
        method: 'POST'
    ...
    it('UserStoryを別のFeatureに移動できる', async () => {
      ...
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/grid/move_user_story`,
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(moveRequest)
  ...
  describe('GET /api/epic_ladder/projects/:projectId/grid/updates', () => {
    it('差分更新データを取得できる', async () => {
      const since = new Date(Date.now() - 1000 * 60 * 5).toISOString(); // 5分前
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/grid/updates?since=${since}`
      );
      const data = await response.json();
  ...
  describe('POST /api/epic_ladder/projects/:projectId/grid/reset', () => {
    it('モックデータをリセットできる', async () => {
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/grid/reset`,
        { method: 'POST' }
      );
      const data = await response.json();
  ...
  describe('POST /api/epic_ladder/projects/:projectId/epics', () => {
    it('Epicを作成できる', async () => {
      ...
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/epics`,
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  describe('POST /api/epic_ladder/projects/:projectId/versions', () => {
    ...
    it('Versionを作成できる', async () => {
      ...
      const response = await fetch(
        `${baseUrl}/api/epic_ladder/projects/${projectId}/versions`,
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(createRequest)
