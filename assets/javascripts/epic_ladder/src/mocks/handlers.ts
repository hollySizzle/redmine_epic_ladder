...
export const handlers = [
  ...
  // グリッドデータ取得
  http.get('/api/epic_ladder/projects/:projectId/grid', async ({ params, request }: { params: PathParams; request: Request }) => {
  ...
  // Feature移動処理
  http.post('/api/epic_ladder/projects/:projectId/grid/move_feature', async ({ request }: { request: Request }) => {
    await delay(200);
  ...
  // 差分更新取得 (ポーリング用)
  http.get('/api/epic_ladder/projects/:projectId/grid/updates', async ({ request }: { request: Request }) => {
    const url = new URL(request.url);
  ...
  // POST /api/epic_ladder/projects/:projectId/grid/reset
  // モックデータリセット (テスト用)
  http.post('/api/epic_ladder/projects/:projectId/grid/reset', async () => {
  ...
  // Feature作成
  http.post('/api/epic_ladder/projects/:projectId/cards', async ({ request }: { request: Request }) => {
    await delay(200);
  ...
  // UserStory作成
  http.post('/api/epic_ladder/projects/:projectId/cards/:featureId/user_stories', async ({ params, request }: { params: PathParams; request: Request }) => {
    await delay(200);
  ...
  // Task作成
  http.post('/api/epic_ladder/projects/:projectId/cards/user_stories/:userStoryId/tasks', async ({ params, request }: { params: PathParams; request: Request }) => {
    await delay(200);
  ...
  // Test作成
  http.post('/api/epic_ladder/projects/:projectId/cards/user_stories/:userStoryId/tests', async ({ params, request }: { params: PathParams; request: Request }) => {
    await delay(200);
  ...
  // Bug作成
  http.post('/api/epic_ladder/projects/:projectId/cards/user_stories/:userStoryId/bugs', async ({ params, request }: { params: PathParams; request: Request }) => {
    await delay(200);
  ...
  // Epic作成
  http.post('/api/epic_ladder/projects/:projectId/epics', async ({ params, request }: { params: PathParams; request: Request }) => {
    await delay(200);
  ...
  // Version作成
  http.post('/api/epic_ladder/projects/:projectId/versions', async ({ params, request }: { params: PathParams; request: Request }) => {
    await delay(200);
  ...
  // POST /api/epic_ladder/projects/:projectId/grid/reorder_epics
  // Epic並び替え処理
  http.post('/api/epic_ladder/projects/:projectId/grid/reorder_epics', async ({ request }: { request: Request }) => {
    await delay(100);
  ...
  // POST /api/epic_ladder/projects/:projectId/grid/reorder_versions
  // Version並び替え処理
  http.post('/api/epic_ladder/projects/:projectId/grid/reorder_versions', async ({ request }: { request: Request }) => {
    await delay(100);
  ...
  // UserStory移動処理
  http.post('/api/epic_ladder/projects/:projectId/grid/move_user_story', async ({ request }: { request: Request }) => {
    await delay(200);
  ...
  // バッチ更新処理（D&D操作の一括保存）
  http.post('/api/epic_ladder/projects/:projectId/grid/batch_update', async ({ request }: { request: Request }) => {
