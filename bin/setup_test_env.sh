...
echo "  RAILS_ENV=test bundle exec rspec plugins/redmine_epic_grid/spec/models --format documentation"
echo "  RAILS_ENV=test bundle exec rspec plugins/redmine_epic_grid/spec/controllers --format documentation"
echo ""
echo "🧪 System テスト実行（Playwright）:"
echo "  cd $REDMINE_ROOT"
echo "  RAILS_ENV=test bundle exec rspec plugins/redmine_epic_grid/spec/system --format documentation"
echo ""
echo "🔍 特定のテスト実行:"
echo "  cd $REDMINE_ROOT"
...
echo ""
echo "📖 ドキュメント:"
echo "  cat plugins/redmine_epic_grid/vibes/docs/temps/playwright-rspec-setup.md"
echo ""
echo "=========================================="
