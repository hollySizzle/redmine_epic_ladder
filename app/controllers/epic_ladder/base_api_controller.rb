...
module EpicLadder
  ...
  class BaseApiController < ApplicationController
    ...
    rescue_from EpicLadder::PermissionDenied, with: :handle_permission_denied
    rescue_from EpicLadder::WorkflowViolation, with: :handle_workflow_error
    ...
    def api_require_login
      ...
      raise EpicLadder::PermissionDenied.new('login', nil, '認証が必要です')
    end
